...
\newcommand{\TLTwoImages}[4][0.46\linewidth]{%
  \begin{center}
    \begin{minipage}[t]{#1}\centering
      \includegraphics[width=\linewidth,height=.25\textheight,keepaspectratio]{#2}\\[-1mm]
      \small #3
    \end{minipage}\hfill
    \begin{minipage}[t]{#1}\centering
      \includegraphics[width=\linewidth,height=.25\textheight,keepaspectratio]{#4}
    \end{minipage}
  \end{center}
}
...
\multicolumn{3}{|c|}{\includegraphics[width=.78\linewidth,height=.18\textheight,keepaspectratio]{images/image15.png}}\\ \hline
...
\includegraphics[width=.58\linewidth,height=.20\textheight,keepaspectratio]{images/image16.jpeg} &
\includegraphics[width=.58\linewidth,height=.20\textheight,keepaspectratio]{images/image17.jpeg} &
\includegraphics[width=.58\linewidth,height=.20\textheight,keepaspectratio]{images/image18.jpeg}\\
