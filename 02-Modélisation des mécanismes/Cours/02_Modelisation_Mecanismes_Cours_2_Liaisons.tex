...
\begin{tabularx}{\linewidth}{|>{\centering\arraybackslash}p{.20\linewidth}|X|}
\hline
...
\end{tabularx}
\end{minipage}\hfill
\begin{minipage}[c]{.23\linewidth}\centering
\includegraphics[width=\linewidth,height=.17\textheight,keepaspectratio]{images/image26.png}
\end{minipage}
\end{center}
...
\begin{tabularx}{\linewidth}{|>{\bfseries\raggedright\arraybackslash\hspace{0pt}}p{.25\linewidth}|>{\raggedright\arraybackslash\hspace{0pt}}X|}
\hline
...
\makecell[l]{Mobilités /\\degrés de liberté} & Tableau des rotations et translations autorisées.\\ \hline
...
\small
\setlength{\tabcolsep}{4pt}
\begin{longtable}{|>{\raggedright\arraybackslash}p{.20\linewidth}|>{\centering\arraybackslash}p{.14\linewidth}|>{\raggedright\arraybackslash}p{.14\linewidth}|>{\raggedright\arraybackslash}p{.32\linewidth}|}
\hline
