...
% Les quelques objets vectoriels Word au format EMF sont fournis dans le dépôt
% sous forme PNG. Graphicx remplace automatiquement l'extension lors de la
% lecture de la partie historique des exercices.
\DeclareGraphicsRule{.emf}{png}{.png}{}
