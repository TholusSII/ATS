...
\TLStartCourseChapter{2}{Modélisation des mécanismes}{chap:modelisation-mecanismes}
...
% TLCours fournit déjà un environnement historique nommé TLExercise. Le fichier
% d'exercices du cours 2 redéfinit volontairement ce nom avec une boîte sécable
% adaptée aux exercices longs ; on libère donc proprement les deux commandes.
\let\TLExercise\relax
\let\endTLExercise\relax
