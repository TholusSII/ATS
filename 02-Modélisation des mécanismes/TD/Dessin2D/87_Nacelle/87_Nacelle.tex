...
\marginnote{Pour le diamètre nominal 150 K7, l'écart supérieur vaut 12 micromètres et l'écart inférieur vaut -28 micromètres.}
...
\question{Partant de la première spécification de localisation, quelle serait l'influence d'un modificateur au maximum de matière sur l'intervalle de tolérance ? sur l'élément de référence ?}


\subsection*{Analyse des procédés de fabrication}
\question{Donner l'ensemble des moyens de fabrication ayant mené à la réalisation de la palette.}
...
\begin{figure*}[htbp]
\centering
\includegraphics[height=.82\textheight]{87_fig_04}
\end{figure*}

\begin{figure*}[htbp]
\centering
\includegraphics[width=.9\textwidth,height=.82\textheight,keepaspectratio]{87_fig_03}
\end{figure*}
