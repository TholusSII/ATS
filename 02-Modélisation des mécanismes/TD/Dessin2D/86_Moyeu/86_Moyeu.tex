...
\begin{center}
\includegraphics[width=.75\linewidth]{86_fig_04}
\end{center}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=.95\textwidth]{86_plan_01}
\end{figure*}

\begin{figure*}[htbp]
\centering
\rotatebox{90}{\includegraphics[width=.85\textheight]{86_plan}}
\end{figure*}
