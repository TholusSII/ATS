...
\CorrigeQuestion{5}
Non. Du cote tige, la section hydraulique utile correspond a la section du piston diminuee de la section de la tige. Du cote oppose, elle correspond a la section complete du piston. Pour une meme course, la difference entre les deux volumes deplaces est donc egale au produit de la section de la tige par la course.
\CorrigeQuestion{6}
Pour une course $L$, le volume refoulé à la sortie 4 est $V_4=S_{\mathrm{utile}}L$. Si la sortie est côté plein piston, $V_4=\pi D^2L/4$; si elle est côté tige, $V_4=\pi(D^2-d^2)L/4$. Le débit moyen vaut ce volume multiplié par la fréquence des courses utiles.
\CorrigeQuestion{7}
