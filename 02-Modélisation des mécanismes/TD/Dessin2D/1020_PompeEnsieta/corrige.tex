...
\CorrigeQuestion{5}
Non. Du côté tige, la section hydraulique utile est annulaire $S_a=S_p-S_t$, alors que de l\textquotesingle autre côté elle vaut $S_p$. À course identique, les volumes sont $V_p=S_p L$ et $V_a=(S_p-S_t)L$; leur différence vaut $S_tL$.
\CorrigeQuestion{6}
