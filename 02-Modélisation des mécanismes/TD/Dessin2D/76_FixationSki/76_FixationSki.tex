...
\exer{Fixation de ski de randonnée}
\label{A5:05:76}
...
\question{Ajouter une spécification de planéité, de tolérance notée tp, sur le plan A.}
\ifprof
\else
\fi

\question{Ajouter une spécification de perpendicularité, de tolérance notée tp, entre A et B. Décoder la spécification.}
\ifprof
\else
\fi
