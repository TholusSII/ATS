...
\includegraphics[width=.8\linewidth]{02_cor}
\includegraphics[width=.8\linewidth]{03_cor}
\includegraphics[width=.8\linewidth]{04_cor}
\includegraphics[width=.8\linewidth]{05_cor}
\end{center}
\else 
\begin{center}
