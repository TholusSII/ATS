...
On considere le repere ayant pour origine $I$ et pour base $(\overrightarrow{x_1},\overrightarrow{y_1},\overrightarrow{z_1})$, tel que $\vect{x_1}$ soit colinéaire à $\vect{IE}$ dans toutes
