...
On considere le repere d'origine $I$ et de base $(\overrightarrow{x_1},\overrightarrow{y_1},\overrightarrow{z_1})$, tel que $\vect{x_1}$ soit colinéaire à $\vect{IE}$ dans toutes
