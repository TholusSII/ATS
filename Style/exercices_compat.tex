...
% s'accumulent, changent automatiquement de placement et peuvent être appelés
% à l'intérieur d'une boîte breakable. Ils sont donc rendus non flottants tout
% en conservant captions et labels.
