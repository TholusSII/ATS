...
% Avec des répertoires accentués, le chargement tardif de TS1 par un symbole
% degré brut peut réinterpréter les accents des chemins comme des commandes T1.
% Le symbole est donc composé directement en mode mathématique.
