\exer{Calculs de produits vectoriels}
\setcounter{exo}{0}
...
\end{enumerate}
\end{multicols}
\question{Est-il nécessaire de projeter des vecteurs pour réaliser les produits vectoriels ? Calculer les produits vectoriels.}
