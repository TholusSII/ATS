...
\question{Donner la forumle de dérivation vectorielle.}

\question{Calculer les dérivées vectorielles suivantes (en exprimant le résultat dans la base la plus simple possible) :}
\begin{multicols}{3}
\begin{enumerate}
