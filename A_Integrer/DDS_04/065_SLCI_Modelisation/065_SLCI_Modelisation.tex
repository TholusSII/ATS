\exer{Modélisation schéma-blocs}
\setcounter{exo}{0}
%E3A MP 2009
...
\question{Donner les valeurs caractéristiques $K_S$ et $T_S$ de la
...
\question{Donner, dans le domaine temporel, l’expression littérale de l’effort développé par le vérin.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{En supposant les conditions initiales nulles, exprimer dans le domaine de Laplace
...
\question{Déterminer l’expression littérale reliant le débit $q_B(t)$, la pression $p_B(t)$ dans la
...
\question{À partir des nouvelles données et des expressions précédentes, déterminer la
