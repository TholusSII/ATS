...
\question{En décalant l’origine temporelle de la valeur du retard pur, déterminer la fonction de transfert
...
\question{En déduire la fonction de transfert tenant compte du retard $H_{\text{frein}}( p)$. On donne la relation suivante entre la transformée de Laplace d’une fonction $x$ non retardée et la transformée de Laplace de cette même fonction avec un
...
\question{Analyser les performances ainsi obtenues avec le correcteur P.I. (pulsation de coupure à
...
\question{Compléter en bleu sur la figue le diagramme de Bode de la boucle ouverte
...
\question{Analyser les performances ainsi obtenues avec le correcteur P.I. (pulsation de coupure à 0 dB et
...
\question{À partir de ces résultats, analyser l’impact du retard pur sur le comportement du système. Quelle(s)
