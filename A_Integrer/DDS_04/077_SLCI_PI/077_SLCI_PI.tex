...
\question{La réponse fréquentielle du module et de la phase dans le plan de Bode de la fonction de
...
\question{Sur le diagramme donnant le module de la fonction de transfert en boucle
...
\question{Justifier alors l’allure de la réponse indicielle de la figure précédente.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{Construire en bleu dans le plan de Bode le module et la phase de la boucle ouverte corrigée incluant le correcteur 
...
\question{Déterminer le gain $K$ de ce correcteur de façon à satisfaire la spécification sur la pulsation de
...
\question{En incluant le correcteur $C_{\gamma t} (p)$ déterminé précédemment, calculer l'erreur en régime
...
\question{Le résultat était-il prévisible dans le cadre de la correction envisagée ? 
