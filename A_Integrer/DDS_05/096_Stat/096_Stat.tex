...
\question{Positionner sur le schéma, à l’aide de vecteurs, les résultantes des actions mécaniques du vérin, du ressort et de la
pesanteur.}
\ifprof
\begin{corrige}
\end{corrrige}
...
\question{Réaliser le graphe de structure et la figure de changement de base.}
\ifprof
\begin{corrige}
\end{corrrige}
\else
...
\question{Isoler 1 et déterminer, lorsque le mécanisme est à l’équilibre, les 6 équations issues du PFS exprimé en $O$.}
\ifprof
\begin{corrige}
\end{corrrige}
\else
...
\question{En déduire les expressions du torseur des actions mécaniques transmises par la liaison entre 1 et 0 et de l’action du motoréducteur.}
\ifprof
\begin{corrige}
\end{corrrige}
\else
...
\question{Exprimer le torseur des actions mécaniques transmises par la liaison entre 1 et 0 en fonction de $m$,$g$, $a$, $b$, $k$, $y$ et $y_0$.}
\ifprof
\begin{corrige}
\end{corrrige}
\else
