...
\question{Sur le schéma cinématique, repasser chaque solide d’une couleur différente. Repérer les liaisons et les lister
...
\question{Réaliser les figures de changement de base, et en déduire le vecteur vitesse angulaire associé à chacune
d’entre elles.}
\ifprof
\begin{corrige}
\end{corrige}
...
\question{Décrire le mouvement de 2/1. Préciser, puis tracer sur le schéma cinématique les trajectoires $T_{G_2\in 2/1}$
$T_{B_2\in 2/1}$.}
\ifprof
\begin{corrige}
\end{corrige}
...
\question{Décrire le mouvement de 1/0. Préciser, puis tracer sur le schéma cinématique les trajectoires $T_{B\in 1/0}$, 
