...
\question{Réaliser le graphe des liaisons. Préciser le paramètre de mouvement associé à chaque liaison. Préciser les
...
\question{Réaliser les figures de changement de base illustrant les paramètres de mouvement angulaires.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{Préciser en le justifiant, le mouvement de 6/1, afin de respecter l’exigence Ex1 du cahier des charges. Que peut-on dire de la base $\mathcal{B}_6 = \base{x_6}{y_6}{z_6}$ ? Donner la relation entre $\beta$ et $\gamma$ afin de garantir ce mouvement ?}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{Donner, en fonction des paramètres de mouvements et des dimensions caractéristiques du mécanisme,
...
\question{Donner, en fonction de $L$ et $y$ , une autre expression de ce vecteur lorsque l’exigence Ex2 est respectée.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{En déduire deux relations mathématiques, traduisant l’exigence Ex2 du cahier des charges, qui lient les
