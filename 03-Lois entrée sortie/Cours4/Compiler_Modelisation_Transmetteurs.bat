...
set "JOB=00_Modelisation_Transmetteurs"
...
for %%N in (ModelisationTransmetteurs_Kaobook 04_Modelisation_Transmetteurs) do (
...
echo Fermer le PDF et tout processus pdflatex, puis relancer ce script.
exit /b 2
