...
\usepackage{hyperref}
\hypersetup{hidelinks,pdftitle={Modélisation des transmetteurs},pdfauthor={Thomas Lusseau}}
\graphicspath{{images/}}
...
\SIChapterOpening{Détermination des lois de mouvement -- Modélisation des transmetteurs}
\begin{center}
  \includegraphics[width=.64\textwidth,height=30mm,keepaspectratio]{images/image3.jpeg}
\end{center}
\vspace{-1mm}
\SIFirstPageTOC
\clearpage
