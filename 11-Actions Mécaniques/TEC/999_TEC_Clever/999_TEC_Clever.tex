...
Le modèle cinématique adopté est précisé par le schéma cinématique de la \autoref{fig_2_5}, ainsi que les données géométriques et les paramètres de mouvement. On note $m$ la masse de l'habitacle et $J_1 = \SI{175}{kg.m^{2}}$ son moment d'inertie par rapport à l'axe $\axe{O}{y_0}$. Les caractéristiques utiles des vérins sont données en annexe.
 ...
 % QUESTION 28
\question{Exprimer l'énergie cinétique galiléenne de l'ensemble des solides \{1,4,5\} en fonction des paramètres cinématiques  $\dot{\alpha}$,  $\dot{\theta}_1$ et  $\dot{\lambda}$.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\end{figure}
 ...
 % QUESTION 29
\question{Déterminer une valeur numérique approximative de $T$.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{Appliquer le théorème de l'énergie cinétique à l'ensemble \{1,4,5\} en négligeant les termes dus aux puissances des poids de 4 et 5. Écrire le résultat sous la forme :
