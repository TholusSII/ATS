...
Le moment d'inertie caractérise la difficulté à modifier la vitesse de rotation du solide autour de l'axe considéré. Son unité est le kilogramme mètre carré : $\si{\kilogram\metre\squared}$.
...
\[
E_c(S/R_g)=\frac12 mV_G^2+\frac12 I_{Gz}\omega^2.
\]
...
Au point $A$ :
\[
\vec\delta_A=\vec\delta_G+\overrightarrow{AG}\wedge m\vec a_G.
\]
