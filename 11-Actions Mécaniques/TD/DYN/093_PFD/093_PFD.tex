...
\question{Proposer une stratégie d’isolements et de calculs à mettre en \oe{}uvre pour déterminer les expressions des
...
\question{Montrer que l’équation différentielle (E2) reliant le couple $C_{M2}$, l’angle $\theta$, le déplacement $x$ et leurs dérivées
...
\question{À partir des équations précédentes, justifier que les mouvements de deux des axes sont couplés.
