...
\hypertarget{mod-mise-en-situation}{%
\subsection{MISE EN SITUATION}\label{mod-mise-en-situation}}

\hypertarget{mod-cas-n1-etuve-thermique}{%
\subsubsection[Cas n°1~: Etuve thermique]{\texorpdfstring{Cas n°1~: Etuve thermique}{Cas n°1~: Etuve thermique}}\label{mod-cas-n1-etuve-thermique}}
...
\includegraphics[width=3.725in,height=2.50208in]{modelisation/images/image6.png}Une résistance électrique alimentée par une tension \(U(t)\) assure le chauffage à l\textquotesingle intérieur de l\textquotesingle étuve. Une sonde de température Pt100, associée à un conditionneur permet de mesurer la température \(\theta(t)\) dans l\textquotesingle étuve.
...
\hypertarget{mod-cas-n2-toit-ouvrant-de-voiture}{%
\subsubsection{Cas n°2~: Toit ouvrant de voiture}\label{mod-cas-n2-toit-ouvrant-de-voiture}}

\begin{quote}
\includegraphics[width=1.82986in,height=0.75in]{modelisation/images/image8.jpeg}Le toit ouvrant est un sous-système du véhicule automobile qui permet une meilleure ventilation de l'habitacle et procure aux passagers des sensations de liberté et une meilleure luminosité. L'ensemble est alimenté par la batterie du véhicule dont la tension est notée \textbf{U\textsubscript{b} = 13 V}.
...
\includegraphics[width=6.89792in,height=2.12014in]{modelisation/images/image9.png}
\end{quote}
...
\hypertarget{mod-introduction-aux-slci}{%
\subsection{INTRODUCTION AUX SLCI}\label{mod-introduction-aux-slci}}
...
\hypertarget{mod-section}{%
\subparagraph*{}\label{mod-section}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-hypothuxe8ses-et-duxe9finitions}{%
\subparagraph*{Hypothèses et Définitions}\label{mod-hypothuxe8ses-et-duxe9finitions}}
...
\hypertarget{mod-propriuxe9tuxe9s}{%
\subparagraph*{Propriétés}\label{mod-propriuxe9tuxe9s}}
...
\includegraphics[width=4.67708in,height=1.80486in]{modelisation/images/image12.png}

\textbf{Superposition}

\includegraphics[width=5.99306in,height=2.09097in]{modelisation/images/image14.png}
...
\hypertarget{mod-moduxe9lisation-de-connaissance}{%
\subsection{Modélisation de connaissance}\label{mod-moduxe9lisation-de-connaissance}}

\hypertarget{mod-systuxe8mes-moduxe9lisables-par-un-gain}{%
\subsubsection{Systèmes modélisables par un gain}\label{mod-systuxe8mes-moduxe9lisables-par-un-gain}}
...
\includegraphics{modelisation/images/image17.jpeg}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
...
\includegraphics{modelisation/images/image24.png}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=1.82986in,height=0.75in]{modelisation/images/image8.jpeg}\textbf{Toit ouvrant}
...
\includegraphics{modelisation/images/image25.png}
\end{quote}
...
\hypertarget{mod-non-linuxe9arituxe9-et-linuxe9arisation}{%
\subsubsection{Non linéarité et linéarisation}\label{mod-non-linuxe9arituxe9-et-linuxe9arisation}}

Pratiquement tous les systèmes physiques présentent des \textbf{non-linéarités}. Voici quelques non-linéarités courantes.

\includegraphics[width=3.77431in,height=1.60833in]{modelisation/images/image27.png}
...
\hypertarget{mod-transformuxe9e-de-laplace}{%
\subsubsection{Transformée de Laplace}\label{mod-transformuxe9e-de-laplace}}

\hypertarget{mod-utilituxe9-de-la-transformuxe9e-de-laplace}{%
\subparagraph*{\texorpdfstring{\textbf{Utilité} de la Transformée de Laplace}{Utilité de la Transformée de Laplace}}\label{mod-utilituxe9-de-la-transformuxe9e-de-laplace}}
...
\hypertarget{mod-duxe9finition}{%
\subparagraph*{Définition}\label{mod-duxe9finition}}
...
\hypertarget{mod-section-1}{%
\subparagraph*{}\label{mod-section-1}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-propriuxe9tuxe9s-de-la-transformuxe9e-de-laplace}{%
\subparagraph*{Propriétés de la transformée de Laplace}\label{mod-propriuxe9tuxe9s-de-la-transformuxe9e-de-laplace}}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=1.41875in,height=1.4in]{modelisation/images/image5.png}\textbf{Etuve thermique}
...
\hypertarget{mod-les-transformuxe9es-de-laplace-des-signaux-tests-sont}{%
\subparagraph*{\texorpdfstring{Les transformées de Laplace des signaux tests sont : }{Les transformées de Laplace des signaux tests sont : }}\label{mod-les-transformuxe9es-de-laplace-des-signaux-tests-sont}}
...
\hypertarget{mod-thuxe9oruxe8mes}{%
\subparagraph*{Théorèmes}\label{mod-thuxe9oruxe8mes}}
...
\item
  \includegraphics[width=2.48125in,height=1.51389in]{modelisation/images/image29.png}Théorème de la valeur initiale~:\(\boxed{\lim_{t \rightarrow 0}\ s(t) = \lim_{p \rightarrow \infty}\ pS(p)}\)
\item
...
\begin{quote}
\includegraphics[width=5.65833in,height=1.65948in]{modelisation/images/image30.png}
\end{quote}
...
\hypertarget{mod-fonctions-de-transfert-cas-guxe9nuxe9rique}{%
\subsubsection{Fonctions de transfert -- cas générique}\label{mod-fonctions-de-transfert-cas-guxe9nuxe9rique}}
...
\hypertarget{mod-muxe9thode-pour-mettre-sous-forme-canonique}{%
\subparagraph*{Méthode pour mettre sous forme canonique~}\label{mod-muxe9thode-pour-mettre-sous-forme-canonique}}
...
\hypertarget{mod-forme-canonique-du-1er-ordre}{%
\subsubsection{\texorpdfstring{Forme canonique du 1\textsuperscript{er} ordre}{Forme canonique du 1er ordre}}\label{mod-forme-canonique-du-1er-ordre}}
...
\hypertarget{mod-fonctions-de-transfert-du-2d-ordre}{%
\subsubsection{\texorpdfstring{Fonctions de transfert du 2\textsuperscript{d} ordre}{Fonctions de transfert du 2d ordre}}\label{mod-fonctions-de-transfert-du-2d-ordre}}
...
\hypertarget{mod-pruxe9voir-le-comportement-dun-systuxe8me-uxe0-partir-de-la-fonction-de-transfert}{%
\subsection{Prévoir le comportement d'un système à partir de la fonction de transfert}\label{mod-pruxe9voir-le-comportement-dun-systuxe8me-uxe0-partir-de-la-fonction-de-transfert}}
...
\hypertarget{mod-pruxe9voir-le-comportement-en-stabilituxe9}{%
\subsubsection{Prévoir le comportement en stabilité}\label{mod-pruxe9voir-le-comportement-en-stabilituxe9}}
...
\hypertarget{mod-condition-de-stabilituxe9}{%
\subparagraph*{Condition de stabilité}\label{mod-condition-de-stabilituxe9}}
...
\includegraphics{modelisation/images/image31.pdf}
...
\hypertarget{mod-pruxe9voir-le-comportement-en-rapidituxe9}{%
\subsubsection{Prévoir le comportement en rapidité}\label{mod-pruxe9voir-le-comportement-en-rapidituxe9}}
...
\hypertarget{mod-rapidituxe9-pour-une-fonction-de-transfert-du-premier-ordre}{%
\subparagraph*{Rapidité pour une fonction de transfert du premier ordre}\label{mod-rapidituxe9-pour-une-fonction-de-transfert-du-premier-ordre}}
...
\hypertarget{mod-pruxe9voir-le-comportement-en-pruxe9cision}{%
\subsection{Prévoir le comportement en précision}\label{mod-pruxe9voir-le-comportement-en-pruxe9cision}}
...
\item
  \begin{quote}
  \protect\hypertarget{mod-_Toc99121097}{}{}\textbf{Prévoir la réponse à un échelon}
  \end{quote}

  \begin{enumerate}
  \def\labelenumii{\arabic{enumii}.}
  \item
    \protect\hypertarget{mod-_Toc99121098}{}{}Modèle proportionnel
  \end{enumerate}
\end{enumerate}
...
\setcounter{enumi}{1}
\item
  \protect\hypertarget{mod-_Toc272938046}{}{}Modèle intégrateur
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  \protect\hypertarget{mod-_Toc379198200}{}{}Réponse indicielle du 1\textsuperscript{er} ordre
\end{enumerate}
...
\hypertarget{mod-duxe9marche-pour-tracer-lallure-dun-1er-ordre}{%
\subparagraph*{\texorpdfstring{Démarche pour tracer l'allure d'un 1er ordre }{Démarche pour tracer l'allure d'un 1er ordre }}\label{mod-duxe9marche-pour-tracer-lallure-dun-1er-ordre}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc99121102}{}{}Réponse à une rampe du 1\textsuperscript{er} ordre
\end{enumerate}
...
\item
  ...
  \def\labelenumi{\arabic{enumi}.}
  \item
    \protect\hypertarget{mod-_Toc99121103}{}{}Réponse du 2\textsuperscript{ème} ordre
  \end{enumerate}
\end{itemize}
...
\hypertarget{mod-m1-ruxe9gime-apuxe9riodique-non-oscillatoire-amorti}{%
\subparagraph*{\texorpdfstring{ m\textgreater1 Régime apériodique (non oscillatoire amorti)}{ m\textgreater1 Régime apériodique (non oscillatoire amorti)}}\label{mod-m1-ruxe9gime-apuxe9riodique-non-oscillatoire-amorti}}
...
\hypertarget{mod-section-2}{%
\subparagraph*{\texorpdfstring{ }{ }}\label{mod-section-2}}
\addcontentsline{toc}{subparagraph}{ }

\hypertarget{mod-m1-ruxe9gime-apuxe9riodique-critique}{%
\subparagraph*{m=1 Régime apériodique critique}\label{mod-m1-ruxe9gime-apuxe9riodique-critique}}
...
\hypertarget{mod-section-3}{%
\subparagraph*{}\label{mod-section-3}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-m1-ruxe9gime-pseudo-puxe9riodique-oscillatoire-amorti}{%
\subparagraph*{\texorpdfstring{0\textless m\textless1 Régime pseudo-périodique (oscillatoire amorti)}{0\textless m\textless1 Régime pseudo-périodique (oscillatoire amorti)}}\label{mod-m1-ruxe9gime-pseudo-puxe9riodique-oscillatoire-amorti}}
...
\hypertarget{mod-section-4}{%
\subparagraph*{}\label{mod-section-4}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-5}{%
\subparagraph*{}\label{mod-section-5}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-6}{%
\subparagraph*{}\label{mod-section-6}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-7}{%
\subparagraph*{}\label{mod-section-7}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-8}{%
\subparagraph*{}\label{mod-section-8}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-9}{%
\subparagraph*{}\label{mod-section-9}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-10}{%
\subparagraph*{}\label{mod-section-10}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-section-11}{%
\subparagraph*{}\label{mod-section-11}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-caractuxe9ristiques-de-la-ruxe9ponse-uxe0-un-uxe9chelon}{%
\subparagraph*{Caractéristiques de la réponse à un échelon}\label{mod-caractuxe9ristiques-de-la-ruxe9ponse-uxe0-un-uxe9chelon}}
...
\includegraphics[width=3.26181in,height=3.19861in]{modelisation/images/image34.png}Lien entre \(m\) et \(D_{k\%}\) :
...
\hypertarget{mod-section-12}{%
\subparagraph*{}\label{mod-section-12}}
\addcontentsline{toc}{subparagraph}{}

\hypertarget{mod-rapidituxe9-pour-une-fonction-de-transfert-du-second-ordre}{%
\subparagraph*{Rapidité pour une fonction de transfert du second ordre}\label{mod-rapidituxe9-pour-une-fonction-de-transfert-du-second-ordre}}
...
\includegraphics[width=3.60556in,height=3.24583in]{modelisation/images/image36.png}

\hypertarget{mod-bilan}{%
\subparagraph*{Bilan}\label{mod-bilan}}
...
\includegraphics[width=4.69048in,height=3.81726in]{modelisation/images/image36.png}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\hypertarget{mod-identifier-un-moduxe8le-de-comportement}{%
\subsection{Identifier un modèle de comportement}\label{mod-identifier-un-moduxe8le-de-comportement}}
...
\hypertarget{mod-muxe9thode-pour-identifier-un-moduxe8le-de-comportement}{%
\subsubsection{Méthode pour identifier un modèle de comportement}\label{mod-muxe9thode-pour-identifier-un-moduxe8le-de-comportement}}
...
\includegraphics[width=1.68472in,height=1.20833in]{modelisation/images/image38.png}\includegraphics[width=1.825in,height=1.10417in]{modelisation/images/image39.png}\includegraphics[width=1.90486in,height=1.14583in]{modelisation/images/image40.png}

\hypertarget{mod-identification-temporelle-dun-1er-ordre}{%
\subsubsection[Identification temporelle d'un 1er ordre]{\texorpdfstring{Identification temporelle d'un 1er ordre}{Identification temporelle d'un 1er ordre}}\label{mod-identification-temporelle-dun-1er-ordre}}

\hypertarget{mod-duxe9marche-pour-un-1er-ordre}{%
\subparagraph*{\texorpdfstring{Démarche pour un 1er ordre }{Démarche pour un 1er ordre }}\label{mod-duxe9marche-pour-un-1er-ordre}}
...
\includegraphics[width=3.40669in,height=2.5875in]{modelisation/images/image38.png}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=2.32917in,height=1.14722in]{modelisation/images/image44.png}\textbf{Robot d'inspection nucléaire tubulaire}

L'asservissement en position de la servovalve permettant de positionner le robot est donné par le schéma-bloc suivant~:

\includegraphics[width=6.05833in,height=0.85347in]{modelisation/images/image45.png}
...
\begin{quote}
\includegraphics[width=4.525in,height=3.4802in]{modelisation/images/image46.pdf}

\textbf{Identifier le modèle de comportement} \(S(p) = \frac{X(p)}{I_{e}(p)}\)
\end{quote}

\includegraphics[width=0.96667in,height=2.08264in]{modelisation/images/image47.jpeg}\textbf{Stabilisateur}
...
\includegraphics[width=4.70833in,height=2.81094in]{modelisation/images/image48.pdf}
...
\includegraphics[width=1.77555in,height=1.19167in]{modelisation/images/image49.png}\includegraphics[width=4.60139in,height=3.4875in]{modelisation/images/image49.png}
...
\hypertarget{mod-identification-temporelle-dun-2uxe8me-ordre-pseudo-puxe9riodique}{%
\subsubsection{\texorpdfstring{Identification temporelle d'un 2\textsuperscript{ème} ordre pseudo-périodique}{Identification temporelle d'un 2ème ordre pseudo-périodique}}\label{mod-identification-temporelle-dun-2uxe8me-ordre-pseudo-puxe9riodique}}

\includegraphics[width=2.32292in,height=1.40486in]{modelisation/images/image39.png}

\hypertarget{mod-duxe9marche-pour-un-2uxe8me-ordre-pseudo-puxe9riodique}{%
\subparagraph*{\texorpdfstring{Démarche pour un 2\textsuperscript{ème} ordre pseudo-périodique}{Démarche pour un 2ème ordre pseudo-périodique}}\label{mod-duxe9marche-pour-un-2uxe8me-ordre-pseudo-puxe9riodique}}
...
\includegraphics[width=2.89653in,height=2.98611in]{modelisation/images/image34.png}

\includegraphics[width=0.61528in,height=0.56875in]{modelisation/images/image50.png}
...
\includegraphics[width=3.41319in,height=2.06528in]{modelisation/images/image39.png}\includegraphics[width=1.34931in,height=1.00972in]{modelisation/images/image41.jpeg}L\textquotesingle étude porte sur la caméra de poursuite Speedcam utilisée aux championnats du monde d\textquotesingle athlétisme pour filmer le sprint final des athlètes en tête de la course. La caméra est fixée sur un chariot se déplaçant sur un rail. Ce rail est le plus petit au monde permettant d\textquotesingle atteindre des vitesses supérieures\\
à 15 m.s\textsuperscript{−1}.
...
\includegraphics[width=3.41319in,height=2.06458in]{modelisation/images/image39.png}
...
\begin{quote}
\includegraphics[width=5.64268in,height=3.30208in]{modelisation/images/image52.pdf}
...
\hypertarget{mod-identification-temporelle-dun-2uxe8me-ordre-apuxe9riodique}{%
\subsubsection{\texorpdfstring{Identification temporelle d'un 2\textsuperscript{ème} ordre apériodique}{Identification temporelle d'un 2ème ordre apériodique}}\label{mod-identification-temporelle-dun-2uxe8me-ordre-apuxe9riodique}}

\includegraphics[width=1.90486in,height=1.14583in]{modelisation/images/image40.png}

\hypertarget{mod-duxe9marche-pour-un-2uxe8me-ordre-apuxe9riodique}{%
\subparagraph*{\texorpdfstring{Démarche pour un 2\textsuperscript{ème} ordre apériodique }{Démarche pour un 2ème ordre apériodique }}\label{mod-duxe9marche-pour-un-2uxe8me-ordre-apuxe9riodique}}
...
\begin{quote}
\includegraphics[width=5.71389in,height=3.4375in]{modelisation/images/image38.png}
\end{quote}
...
\includegraphics[width=3.51464in,height=2.11458in]{modelisation/images/image38.png}\includegraphics[width=1.34931in,height=1.00972in]{modelisation/images/image41.jpeg}L\textquotesingle étude porte sur la caméra de poursuite Speedcam utilisée aux championnats du monde d\textquotesingle athlétisme pour filmer le sprint final des athlètes en tête de la course. La caméra est fixée sur un chariot se déplaçant sur un rail. Ce rail est le plus petit au monde permettant d\textquotesingle atteindre des vitesses supérieures\\
à 15 m.s\textsuperscript{−1}.
...
\begin{quote}
\includegraphics[width=3.51464in,height=2.11458in]{modelisation/images/image40.png}Pas de dépassement, tangente à l'origine nulle, c'est un modèle du deuxième ordre apériodique \(\Longrightarrow\) \(H(p) = \frac{H_{0}}{\left( 1 + \tau_{1}p \right)\left( 1 + \tau_{2}p \right)}\)
\end{quote}
...
\hypertarget{mod-ruxe9duction-de-lordre-dun-moduxe8le}{%
\subsubsection{Réduction de l'ordre d'un modèle}\label{mod-ruxe9duction-de-lordre-dun-moduxe8le}}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=1.12917in,height=0.78542in]{modelisation/images/image54.jpeg}\textbf{Roburoc}
...
\hypertarget{mod-manipulation-des-blocs}{%
\subsection{Manipulation des blocs}\label{mod-manipulation-des-blocs}}

\SAChaineAsservie


\hypertarget{mod-eluxe9ments-de-bases}{%
\subsubsection{Eléments de bases}\label{mod-eluxe9ments-de-bases}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc99121080}{}{}\textbf{Chaîne directe et chaîne de retour}
\end{enumerate}
...
\item
  ...
  \def\labelenumi{\arabic{enumi}.}
  \item
    \protect\hypertarget{mod-_Toc149497259}{}{}\textbf{Adaptateurs}
  \end{enumerate}
\end{itemize}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=1.34167in,height=1in]{modelisation/images/image55.png}\textbf{Réservoir incendie}

\includegraphics[width=5.45545in,height=2.57618in]{modelisation/images/image56.jpeg}Pour pouvoir faire face en cas d'incendie, de nombreuses communes disposent d'un réservoir d'eau. Le réservoir étudié est alimenté en eau par une pompe. La hauteur d'eau est mesurée par un capteur de pression placé au fond du réservoir. On peut schématiser le fonctionnement du système par la figure suivante~:
...
\setcounter{enumi}{1}
\item
  \protect\hypertarget{mod-_Toc149497260}{}{}\textbf{Quelques blocs classiques}
\end{enumerate}
...
\hypertarget{mod-simplifier-un-schuxe9ma-bloc}{%
\subsubsection{Simplifier un schéma-bloc}\label{mod-simplifier-un-schuxe9ma-bloc}}
...
\includegraphics[width=0.62627in,height=0.65083in]{modelisation/images/image23.png}
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=2.86806in,height=0.90069in]{modelisation/images/image59.png}\textbf{Exemple}

\textbf{Donner la fonction de transfert} \(\frac{\mathbf{S(p)}}{\mathbf{E(p)}}\)

\includegraphics[width=2.91667in,height=0.72552in]{modelisation/images/image60.png} \textbf{Donner la fonction de transfert sous forme canonique et identifier ses paramètres caractéristiques} \(\frac{\mathbf{X(p)}}{\mathbf{W(p)}}\)
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\hypertarget{mod-schuxe9ma-bloc-uxe9quivalent}{%
\subsubsection{Schéma-bloc équivalent}\label{mod-schuxe9ma-bloc-uxe9quivalent}}
...
\begin{quote}
\includegraphics[width=5.61053in,height=2.1574in]{modelisation/images/image61.png}
...
\includegraphics{modelisation/images/image62.png}

\includegraphics[width=5.63904in,height=1.79167in]{modelisation/images/image63.png}
\end{quote}
\end{minipage} \\
\midrule\noalign{}
\endhead
...
\hypertarget{mod-systuxe8mes-asserivs-perturbuxe9s}{%
\subsection{Systèmes asserivs perturbés}\label{mod-systuxe8mes-asserivs-perturbuxe9s}}

\hypertarget{mod-perturbation}{%
\subsubsection{Perturbation}\label{mod-perturbation}}
...
\includegraphics[width=1.43056in,height=0.83056in]{modelisation/images/image64.jpeg}
...
\hypertarget{mod-schuxe9ma-bloc-dun-systuxe8me-perturbuxe9}{%
\subsubsection{Schéma-bloc d'un système perturbé}\label{mod-schuxe9ma-bloc-dun-systuxe8me-perturbuxe9}}
...
\hypertarget{mod-thuxe9oruxe8me-de-superposition}{%
\subsubsection{Théorème de superposition}\label{mod-thuxe9oruxe8me-de-superposition}}
...
\includegraphics[width=3.30208in,height=1.43889in]{modelisation/images/image65.jpeg}

\textbf{Cas où P(p) = 0}

\includegraphics[width=3.36042in,height=1.11806in]{modelisation/images/image66.jpeg}
...
\includegraphics[width=3.17902in,height=1.59263in]{modelisation/images/image67.jpeg}\textbf{Cas où E(p) = 0}
...
\includegraphics[width=3.2in,height=1.61667in]{modelisation/images/image68.png}

Donner \(X(p)\) en fonction de \(W(p)\) et \(Z(p)\)

\includegraphics[width=4.40476in,height=1.85in]{modelisation/images/image69.png}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\hypertarget{mod-stabilituxe9-dun-moduxe8le-perturbuxe9}{%
\subsubsection{Stabilité d'un modèle perturbé}\label{mod-stabilituxe9-dun-moduxe8le-perturbuxe9}}
...
\hypertarget{mod-pruxe9cision-dun-moduxe8le-perturbuxe9}{%
\subsubsection{Précision d'un modèle perturbé}\label{mod-pruxe9cision-dun-moduxe8le-perturbuxe9}}
...
\hypertarget{mod-erreur-statique-dun-systuxe8me-non-perturbuxe9}{%
\subsubsection{Erreur statique d'un système non perturbé}\label{mod-erreur-statique-dun-systuxe8me-non-perturbuxe9}}
...
\includegraphics[width=2.91667in,height=0.72552in]{modelisation/images/image60.png}
...
\includegraphics[width=5.58497in,height=1.47619in]{modelisation/images/image70.png}
...
\hypertarget{mod-erreur-statique-due-uxe0-la-perturbation}{%
\subsubsection{Erreur statique due à la perturbation}\label{mod-erreur-statique-due-uxe0-la-perturbation}}
...
\hypertarget{mod-rejet-de-perturbation}{%
\subsubsection{Rejet de perturbation}\label{mod-rejet-de-perturbation}}
...
\includegraphics[width=5.46429in,height=2.14749in]{modelisation/images/image71.png}

\textbf{Système 2}

\includegraphics{modelisation/images/image72.png}

\textbf{Système 3}

\includegraphics{modelisation/images/image73.png}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\item
  \begin{quote}
  \protect\hypertarget{mod-_Toc149497272}{}{}\textbf{Analyse fréquentielle}
  \end{quote}
\end{enumerate}
...
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
\includegraphics[width=1.58333in,height=1.16667in]{modelisation/images/image74.jpeg}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc337686831}{}{}\textbf{Caractéristiques}
\end{enumerate}
...
\includegraphics[width=0.61528in,height=0.56875in]{modelisation/images/image50.png}- le déphasage \(\varphi\), appelé \textbf{phase} {[}en rad ou en °{]}, est aussi \textbf{constant}.
\end{quote}
...
\setcounter{enumi}{1}
\item
  \protect\hypertarget{mod-_Toc272749600}{}{}\textbf{Obtention de la réponse harmonique expérimentalement}
\end{enumerate}
...
\setcounter{enumi}{2}
\item
  \protect\hypertarget{mod-_Toc387521156}{}{}\textbf{Fonction de transfert complexe}
\end{enumerate}
...
\hypertarget{mod-lieux-de-transferts}{%
\subsubsection{Lieux de transferts}\label{mod-lieux-de-transferts}}
...
\hypertarget{mod-duxe9cade-octave-duxe9cibel-propriuxe9tuxe9s-du-log10}{%
\subsubsection{\texorpdfstring{Décade, Octave, décibel, propriétés du log\textsubscript{10}}{Décade, Octave, décibel, propriétés du log10}}\label{mod-duxe9cade-octave-duxe9cibel-propriuxe9tuxe9s-du-log10}}
...
\includegraphics{modelisation/images/image96.pdf}\includegraphics{modelisation/images/image97.pdf}

\textbf{Exemple~:}

Un avion émet 120 dB au décollage, combien de dB émettent deux avions identiques décollant ensemble ? Réponse : 123 dB

\hypertarget{mod-intuxe9ruxeat-de-luxe9chelle-logarithmique}{%
\subsubsection{Intérêt de l'échelle logarithmique}\label{mod-intuxe9ruxeat-de-luxe9chelle-logarithmique}}
...
\includegraphics[width=3.76806in,height=0.5in]{modelisation/images/image98.pdf}\(G(\omega) = 20.log_{10}\left| {\underline{H}}_{1}(j\omega) \right| + 20.log_{10}\left| {\underline{H}}_{2}(j\omega) \right| = G_{1}(\omega) + G_{2}(\omega)\)
...
\hypertarget{mod-gain-et-phase}{%
\subsubsection{Gain et phase}\label{mod-gain-et-phase}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc387521153}{}{}\textbf{Définition du diagramme de Bode}
\end{enumerate}
...
\includegraphics[width=0.61528in,height=0.56875in]{modelisation/images/image50.png}Attention, car c'est le gain en décibel \(G_{dB}(\omega)\) qui est relevé sur le diagramme. Il faut ensuite, à partir de cette valeur, calculer le gain \(G(\omega)\).
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc494227256}{}{}\textbf{Filtre, pulsation de coupure et bande passante}
\end{enumerate}
...
\textbf{Si le système est précis alors le diagramme de Bode aura} \textbf{une asymptote en dB aux basses fréquences égale à 0 dB}.\protect\hypertarget{mod-_Toc494227260}{}{}
\end{quote}
...
\setcounter{enumi}{1}
\item
  \protect\hypertarget{mod-_Toc337686846}{}{}\textbf{Modèle intégrateur}
\end{enumerate}
...
\setcounter{enumi}{4}
\item
  \protect\hypertarget{mod-_Toc99121126}{}{}\textbf{Modèle du 1\textsuperscript{er} ordre}
\end{enumerate}
...
\setcounter{enumi}{5}
\item
  \protect\hypertarget{mod-_Toc494227268}{}{}\textbf{Modèle du 1\textsuperscript{er} ordre inverse}
\end{enumerate}
...
\includegraphics{modelisation/images/image99.pdf}

\(H(p) = \frac{4}{(2 + 0,1.p)}\)

\includegraphics{modelisation/images/image100.pdf}
...
\includegraphics{modelisation/images/image99.pdf}\(H(p) = \frac{2}{p}\)

\includegraphics{modelisation/images/image100.pdf}

\[H(p) = \frac{p}{5}\]

\includegraphics{modelisation/images/image99.pdf}\(H(p) = \frac{8}{2 + 10^{- 8}p}\)

\includegraphics{modelisation/images/image100.pdf}\(H(p) = \frac{3 + 0,01p}{p}\)
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\setcounter{enumi}{6}
\item
  \protect\hypertarget{mod-_Toc28847704}{}{}\textbf{Méthode pour tracer les diagrammes de Bode}
\end{enumerate}
...
\setcounter{enumi}{7}
\item
  \protect\hypertarget{mod-_Toc99121133}{}{}\textbf{Méthode pour tracer un diagramme de Bode}
\end{enumerate}
...
\includegraphics{modelisation/images/image99.pdf}\(H(p) = \frac{2(1 + 2p)}{(1 + 0,2p)(1 + 10p)}\)

\includegraphics{modelisation/images/image100.pdf}\(H(p) = \frac{2(1 + 0,01p)}{p(1 + {2.10}^{- 3}p)(1 + 0,5p)}\)

\[H(p) = \frac{10(1 + 0,5.p)(1 + 2.p)}{(1 + 5.p)\left( 1 + 2.10^{- 3}.p \right)}\]

\includegraphics{modelisation/images/image99.pdf}

\(H(p) = \frac{500}{p(1 + 0,005.p)}\)\includegraphics{modelisation/images/image99.pdf}

\includegraphics{modelisation/images/image100.pdf}\includegraphics{modelisation/images/image100.pdf}\(H(p) = \frac{2(1 + 0,01.p)(1 + 0,1.p)}{p(1 + 0,005.p)}\)
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc149497291}{}{}\textbf{Modèle du 2\textsuperscript{ème} ordre}
\end{enumerate}
...
\includegraphics{modelisation/images/image101.pdf}\textbf{Tracer l'allure des diagrammes de Bode asymptotiques et réels des fonctions de transfert.}

\[H(p) = \frac{2}{(1 + 0,05.p)\left( 1 + 2.10^{- 3}.p \right)}\]

\(H(p) = \frac{2}{(1 + 0,05.p)^{2}}\)\includegraphics{modelisation/images/image100.pdf}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\(H(p) = \frac{2}{1 + 0,5p + 0,005p^{2}}\)\includegraphics{modelisation/images/image99.pdf}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\hypertarget{mod-bilan-du-comportement-dun-moduxe8le-du-2uxe8me-ordre}{%
\subsubsection{Bilan du comportement d'un modèle du 2ème ordre}\label{mod-bilan-du-comportement-dun-moduxe8le-du-2uxe8me-ordre}}

\TLBodeSecondOrdre[1][0.7][1]


\includegraphics{modelisation/images/image102.pdf}

\hypertarget{mod-tracuxe9-de-bode-ruxe9el}{%
\subsubsection{Tracé de Bode réel}\label{mod-tracuxe9-de-bode-ruxe9el}}
...
\hypertarget{mod-muxe9thode-pour-identifier-un-diagramme-de-bode}{%
\subsubsection{Méthode pour identifier un diagramme de Bode}\label{mod-muxe9thode-pour-identifier-un-diagramme-de-bode}}
...
\includegraphics[width=6.10417in,height=4.57813in]{modelisation/images/image103.pdf}

\includegraphics[width=6.10417in,height=4.57813in]{modelisation/images/image104.pdf}

\includegraphics[width=6.08333in,height=4.5625in]{modelisation/images/image105.pdf}

\includegraphics[width=6.08333in,height=4.5625in]{modelisation/images/image106.pdf}

\includegraphics[width=5.83333in,height=4.375in]{modelisation/images/image107.pdf}
\end{minipage} \\
\midrule\noalign{}
\endhead
\bottomrule\noalign{}
...
\hypertarget{mod-etude-de-la-stabilituxe9-point-critique}{%
\subsection{Etude de la stabilité -- Point critique}\label{mod-etude-de-la-stabilituxe9-point-critique}}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \protect\hypertarget{mod-_Toc59134857}{}{}\textbf{Critère du revers dans le plan de Black -- hors programme}
\end{enumerate}
...
\setcounter{enumi}{1}
\item
  \protect\hypertarget{mod-_Toc59134858}{}{}\textbf{Marge de phase et marge de gain des systèmes asservis}
\end{enumerate}
...
Fonction de transfert du correcteur : \includegraphics{modelisation/images/image108.pdf}

Fonction de transfert en boucle ouverte : \includegraphics{modelisation/images/image109.pdf}
...
\begin{quote}
\includegraphics{modelisation/images/image110.pdf}

\includegraphics[width=6.34375in,height=4.79167in]{modelisation/images/image111.pdf}

\includegraphics{modelisation/images/image112.pdf}\includegraphics[width=6.34375in,height=4.79167in]{modelisation/images/image113.pdf}

\includegraphics{modelisation/images/image114.pdf}\includegraphics[width=6.34375in,height=4.52778in]{modelisation/images/image115.pdf}

\includegraphics{modelisation/images/image116.pdf}

\includegraphics[width=6.34375in,height=4.79167in]{modelisation/images/image117.pdf}
\end{quote}
...
\hypertarget{mod-performances-uxe0-uxe9tudier-en-ftbo-ou-en-ftbf}{%
\subsubsection{Performances à étudier en FTBO ou en FTBF}\label{mod-performances-uxe0-uxe9tudier-en-ftbo-ou-en-ftbf}}



\hypertarget{mod-sources}{%
\subsection{Sources}\label{mod-sources}}
