...
\question{À partir de la figure précédente et par la méthode de votre choix, déterminer
...
\question{À partir de la fonction de transfert $H(p)$ et de l’équation établie précédemment, compléter le schéma-blocs suivant.}
\ifprof
\begin{corrige}
\end{corrige}
\else
...
\question{Donner l’expression de la fonction de transfert en boucle ouverte du système.}
\ifprof
\begin{corrige}
\end{corrige}
\else
