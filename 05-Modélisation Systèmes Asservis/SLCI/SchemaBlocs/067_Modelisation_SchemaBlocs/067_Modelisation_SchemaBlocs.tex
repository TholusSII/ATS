\exer{Modélisation fonctions de transfert}
\setcounter{exo}{0}
%CCS PSI 2008
...
%\question{Montrer que l’évolution de la vitesse de rotation du stator est
...
\question{Préciser les relations liant :
\begin{itemize}
...
\question{Déterminer une équation différentielle, à paramètres variant dans le temps,
...
\question{En supposant en première approximation que les variations sont nulles, déterminer
...
\question{Montrer que la fonction de transfert $\dfrac{\Omega_1(p)}{U_1(p)}$ peut être approchée sous
