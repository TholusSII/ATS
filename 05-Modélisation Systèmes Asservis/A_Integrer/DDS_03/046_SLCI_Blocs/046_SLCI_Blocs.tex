...
\question{Mettre le premier schéma-blocs sous la forme du second schéma-blocs. Exprimer les fonctions de transfert $H_1(p)$ et $H_2(p)$ en fonction des paramètres du premier schéma-blocs.}
\ifprof
\begin{corrige}
\end{corrige}
\else
