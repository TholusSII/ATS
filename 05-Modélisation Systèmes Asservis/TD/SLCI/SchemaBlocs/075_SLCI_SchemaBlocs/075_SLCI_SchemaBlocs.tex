...
\question{Montrer que le schéma bloc du système peut se mettre sous la forme suivante en déterminant l’expression littérale de $H_1(p)$.}
\ifprof
\begin{corrige}
\end{corrige}
\else
