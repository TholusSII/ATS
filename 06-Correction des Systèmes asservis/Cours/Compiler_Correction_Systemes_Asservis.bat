...
set "JOB=00_Correction_Systemes_Asservis"

echo ============================================================
echo Nettoyage des fichiers auxiliaires du cours 06
echo ============================================================
...
for %%N in (06_Correction_Systemes_Asservis CorrectionSA_Kaobook) do (
