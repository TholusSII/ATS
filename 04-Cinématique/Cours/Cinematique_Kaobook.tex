...
\usepackage{xparse,needspace,etoolbox,tikz,amsmath}
\usepackage{hyperref}
\hypersetup{hidelinks,pdftitle={Approche cinématique},pdfauthor={Thomas Lusseau}}
\graphicspath{{images/}}
...
\addtokomafont{subsection}{\color{kaoblue}}
\addtokomafont{subsubsection}{\color{SIOrange}}
...
\SIChapterOpening{Détermination des lois de mouvement -- Approche cinématique}
\begin{center}
  \includegraphics[width=.64\textwidth,height=30mm,keepaspectratio]{images/image3.png}
\end{center}
\vspace{-1mm}
\SIFirstPageTOC
\clearpage
