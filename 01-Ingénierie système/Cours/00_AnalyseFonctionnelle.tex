...
% Charger explicitement les versions du framework stockées dans Style afin
% d'éviter qu'une autre copie de kaobook installée par MiKTeX soit utilisée.
\usepackage{\repStyle/kaobiblio}
\addbibresource{Cy_01_ModelisationSystemes.bib}
\usepackage{\repStyle/kaotheorems}
\usepackage{\repStyle/kaorefs}
