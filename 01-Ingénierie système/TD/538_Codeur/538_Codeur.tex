...
% ATS 2019
\exer{Codeur incrémental -- exercice approfondi}
\label{SYS:01:538}
...
\question{Le codeur est équipé d'une voie de mesure et d'un disque à 25 fentes. Donner la résolution du capteur en degrés.}
\ifprof
\else
\fi
...
\ifprof
\else
La position du codeur est transformée par un convertisseur numérique-analogique en volts. Ce convertisseur permet de convertir des angles variant de -10 tours à +10 tours sur une échelle de \SI{-5}{V} à \SI{5}{V}.
\fi
