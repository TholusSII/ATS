...
% ATS 2019
\exer{Vérin double effet -- exercice approfondi}
\label{SYS:01:A3:05:1100}
...
\par\medskip
\begin{center}
\includegraphics[width=.82\linewidth]{1100_fig_01}
\end{center}
\par\medskip

\question{Compléter le câblage du distributeur.}

\question{Dans la position actuelle, indiquer par des flèches le sens de déplacement du vérin. Indiquer en rouge les tuyaux et chambres hautes pressions. Indiquer en bleu les tuyaux et chambres basses pressions.}
...
\par\medskip
\begin{center}
\includegraphics[width=.82\linewidth]{1100_fig_02}
\end{center}
\par\medskip
...
Si la pression augmente trop, le limiteur de pression (d) renvoie une partie du fluide vers le
réservoir. Si cela est insuffisant, le module (b) permet une décharge du circuit par ouverture vers le réservoir,
jusqu’à atteindre le niveau bas réglé.
